    ...
    <div className="flex-none  bg-black h-screen min-w-[25%] fixed ">
      <div className="nav flex  text-white text-lg mt-10 flex-col align-middle justify-center text-center w-full gap-5 overflow-hidden">
        <div data-aos="slide-down">
          <img
            src={require("../assets/images/akuu.webp")}
            alt="Cindi"
            className="rounded-full border-solid cursor-pointer  border-[8px] border-stone-600 min-h-fit mx-auto  max-w-[200px]"
          />
      ...
      >
        <div
          onClick={() =>
            window.open("https://github.com/Cindidev913", "_blank")
          }
        >
        ...
        <div
          onClick={() =>
            window.open("https://www.instagram.com/cindiwdwt_/", "_blank")
          }
        >
          {" "}
        ...
        <div
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/cindi-widiawati-9a907b253/",
              "_blank"
            )
          }
        >
        ...
        <div
          onClick={() =>
            window.open("https://web.facebook.com/cindi.widiawati.9", "_blank")
          }
        >
